...
export default function LoginScreen() {
        ...
        Alert.alert(
          ...
          [
            ...
            },
            {
              ...
              onPress: () => proceedAfterLogin(result),
            },
          ]
        );
        setLoading(false);
  ...
  // ── Helper: handles agreement check and navigation after login ────────────
          ...
          <View style={[styles.loginCard, { backgroundColor: colors.cardBackground }]}>
            ...
            <View style={styles.roleSection}>
              ...
              <View style={[styles.roleToggle, { backgroundColor: colors.background }]}>
                ...
                >
                  <Ionicons name="person" size={20} color={selectedRole === 'customer' ? colors.accent : colors.textSecondary} />
                  <Text style={[styles.roleButtonText, { color: colors.textSecondary }, selectedRole === 'customer' && [styles.roleButtonTextActive, { color: colors.accent }]]}>
                    Customer
                  </Text>
                </TouchableOpacity>
                ...
                >
                  <Ionicons name="briefcase" size={20} color={selectedRole === 'provider' ? colors.accent : colors.textSecondary} />
                  <Text style={[styles.roleButtonText, { color: colors.textSecondary }, selectedRole === 'provider' && [styles.roleButtonTextActive, { color: colors.accent }]]}>
                    Provider
                  </Text>
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 24, paddingTop: 64, paddingBottom: 32, alignItems: 'center' },
  title: { fontSize: 36, fontWeight: 'bold', color: '#fff', marginTop: 8, marginBottom: 8 },
  subtitle: { fontSize: 14, color: '#bfdbfe' },
  loginCard: { marginHorizontal: 24, backgroundColor: '#fff', borderRadius: 24, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 8 },
  roleSection: { marginBottom: 24 },
  roleLabel: { fontSize: 14, fontWeight: '600', color: '#6b7280', textAlign: 'center', marginBottom: 12 },
  roleToggle: { flexDirection: 'row', backgroundColor: '#f3f4f6', borderRadius: 16, padding: 4, gap: 4 },
  roleButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, borderRadius: 12, gap: 8 },
  roleButtonActive: { backgroundColor: '#fff', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
  roleButtonText: { fontSize: 14, fontWeight: '600', color: '#6b7280' },
  roleButtonTextActive: { color: '#2563eb' },
  inputGroup: { marginBottom: 16 },
  label: { fontSize: 14, fontWeight: '600', color: '#374151', marginBottom: 8 },
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#d1d5db', borderRadius: 12, paddingHorizontal: 16 },
  ...
  loginButton: { backgroundColor: '#2563eb', paddingVertical: 16, borderRadius: 12, alignItems: 'center', shadowColor: '#2563eb', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 },
  ...
  socialButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 12, borderWidth: 1, borderColor: '#d1d5db', borderRadius: 12, gap: 8 },
  ...
  roleInfo: { marginHorizontal: 24, marginTop: 24, backgroundColor: 'rgba(255, 255, 255, 0.1)', borderRadius: 16, padding: 16 },
  roleInfoText: { fontSize: 14, color: '#fff', textAlign: 'center' },
