...
export default function Marketplace() {
    ...
    return (
      ...
      // In marketplace.tsx - update bottom nav tabs
                {[
...
const styles = StyleSheet.create({
    ...
    // Header
    header:             { backgroundColor: '#0d1629', paddingHorizontal: 16, paddingTop: 12, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)', zIndex: 10 },
    headerTop:          { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
    backBtn:            { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.1)', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
    headerCenter:       { flex: 1 },
    ...
    searchBar:          { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e2d4a', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    searchInput:        { flex: 1, fontSize: 14, color: '#fff', padding: 0 },
  
    // Section
    sectionTitle:       { fontSize: 16, fontWeight: '700', color: '#fff', marginTop: 16, marginBottom: 10 },
    productCount:       { fontSize: 13, color: '#64748b', marginTop: 16 },
    productsHeader:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  
    // Categories
    categoryScroll:     { marginBottom: 4 },
    categoryPill:       { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e2d4a', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8, marginRight: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    ...
    productCard:        { width: '48.5%', backgroundColor: '#1e2d4a', borderRadius: 16, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 4, elevation: 2 },
    productImageBox:    { backgroundColor: 'rgba(37,99,235,0.1)', borderRadius: 12, height: 80, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
    productEmoji:       { fontSize: 36 },
    productName:        { fontSize: 13, fontWeight: '700', color: '#fff', marginBottom: 4 },
    productDesc:        { fontSize: 11, color: '#64748b', marginBottom: 4, lineHeight: 16 },
    productUnit:        { fontSize: 11, color: '#60a5fa', fontWeight: '600', marginBottom: 4 },
    ratingRow:          { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
    ratingText:         { fontSize: 11, fontWeight: '600', color: '#fff', marginLeft: 3 },
    reviewText:         { fontSize: 11, color: '#64748b', marginLeft: 2 },
    productPrice:       { fontSize: 16, fontWeight: '800', color: '#2563eb', marginBottom: 8 },
    addBtn:             { flexDirection: 'row', backgroundColor: '#2563eb', borderRadius: 10, paddingVertical: 8, justifyContent: 'center', alignItems: 'center' },
    ...
    qtyPlus:            { backgroundColor: '#2563eb', width: 28, height: 28, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
    qtyText:            { fontSize: 14, fontWeight: '700', color: '#fff' },
  
    // Empty
    emptyCard:          { backgroundColor: '#1e2d4a', borderRadius: 16, padding: 32, alignItems: 'center', marginTop: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    emptyTitle:         { fontSize: 16, fontWeight: '600', color: '#94a3b8', marginTop: 12 },
    emptySubtitle:      { fontSize: 13, color: '#64748b', marginTop: 4 },
  
    // Info Banner
    infoBanner:         { flexDirection: 'row', backgroundColor: 'rgba(37,99,235,0.1)', borderWidth: 1, borderColor: 'rgba(37,99,235,0.2)', borderRadius: 16, padding: 16, marginTop: 8, marginBottom: 16, alignItems: 'center' },
    infoBannerEmoji:    { fontSize: 32, marginRight: 14 },
    infoBannerText:     { flex: 1 },
    infoBannerTitle:    { fontSize: 15, fontWeight: '700', color: '#60a5fa', marginBottom: 4 },
    infoBannerDesc:     { fontSize: 12, color: '#93c5fd', lineHeight: 18 },
  
    // Modal
    modalOverlay:       { flex: 1, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'flex-end' },
    modalSheet:         { backgroundColor: '#0d1629', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '85%', paddingBottom: 30, borderTopWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    ...
    modalClose:         { width: 36, height: 36, borderRadius: 18, backgroundColor: '#1e2d4a', justifyContent: 'center', alignItems: 'center' },
    modalScroll:        { paddingHorizontal: 20 },
    emptyCart:          { alignItems: 'center', paddingVertical: 40 },
    emptyCartText:      { fontSize: 16, fontWeight: '600', color: '#94a3b8', marginTop: 12, marginBottom: 20 },
    continueBtn:        { backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 12, paddingHorizontal: 28 },
    continueBtnText:    { color: '#fff', fontWeight: '700', fontSize: 14 },
    cartItem:           { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e2d4a', borderRadius: 12, padding: 12, marginTop: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    ...
    cartItemTotal:      { fontSize: 14, fontWeight: '700', color: '#2563eb', marginLeft: 10 },
    summaryBox:         { backgroundColor: 'rgba(37,99,235,0.1)', borderRadius: 14, padding: 16, marginTop: 16, borderWidth: 1, borderColor: 'rgba(37,99,235,0.2)' },
    summaryRow:         { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
    summaryLabel:       { fontSize: 14, color: '#94a3b8' },
    summaryValue:       { fontSize: 14, fontWeight: '600', color: '#fff' },
    summaryTotal:       { fontSize: 15, fontWeight: '700', color: '#fff' },
    summaryTotalValue:  { fontSize: 18, fontWeight: '800', color: '#2563eb' },
    checkoutBtn:        { backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
