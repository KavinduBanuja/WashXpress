...
const styles = StyleSheet.create({
    ...
    header: { backgroundColor: '#16a34a', paddingHorizontal: 16, paddingTop: 12, paddingBottom: 14, shadowColor: '#16a34a', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8, zIndex: 10 },
    ...
    cartBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
    ...
    productImageBox: { backgroundColor: '#f0fdf4', borderRadius: 12, height: 80, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
    ...
    productUnit: { fontSize: 11, color: '#16a34a', fontWeight: '600', marginBottom: 4 },
    ...
    productPrice: { fontSize: 16, fontWeight: '800', color: '#16a34a', marginBottom: 8 },
    addBtn: { flexDirection: 'row', backgroundColor: '#16a34a', borderRadius: 10, paddingVertical: 8, justifyContent: 'center', alignItems: 'center' },
    ...
    infoBanner: { flexDirection: 'row', backgroundColor: '#f0fdf4', borderWidth: 1, borderColor: '#bbf7d0', borderRadius: 16, padding: 16, marginTop: 8, marginBottom: 16, alignItems: 'center' },
    infoBannerEmoji: { fontSize: 32, marginRight: 14 },
    infoBannerText: { flex: 1 },
    infoBannerTitle: { fontSize: 15, fontWeight: '700', color: '#15803d', marginBottom: 4 },
    infoBannerDesc: { fontSize: 12, color: '#16a34a', lineHeight: 18 },
    ...
    continueBtn: { backgroundColor: '#16a34a', borderRadius: 14, paddingVertical: 12, paddingHorizontal: 28 },
    ...
    cartItemTotal: { fontSize: 14, fontWeight: '700', color: '#16a34a', marginLeft: 10 },
    summaryBox: { backgroundColor: '#f0fdf4', borderRadius: 14, padding: 16, marginTop: 16 },
    ...
    checkoutBtn: { backgroundColor: '#16a34a', borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginTop: 16 },
